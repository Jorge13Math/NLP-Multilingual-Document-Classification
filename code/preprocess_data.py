...
class Preprocces:
    ...
    def clean_dataframe(self):
        ...
        df['Cleaned_text'] = df['Text'].apply(lambda x: re.sub(r'\w*\d\w*', '', x))
    ...
    def plot_language_category(self, df):
        ...
        pd.pivot_table(df_language, index='language', columns='label',
                       values='value').plot(kind='bar', grid=True, figsize=(8, 5))
